...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-content">
            ...
            <input style="width: 170px" type="text" name="daterange" />
...
<script type="text/javascript">
   ...
   var endDate = moment();
    ...
    window.onload = function () {
        revenueBrand(startDate.format('YYYY-MM-DD'),endDate.format('YYYY-MM-DD'));
    }
    ...
    $(function () {
        $('input[name="daterange"]').daterangepicker({
            ...
            revenueBrand(year1,year2);
            // alert("A new date selection was made: " + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD'));
        });
    });

    function revenueBrand(year1,year2){
        $.ajax({
            url: '/admin/revenue/revenueByBrand',
            type: 'POST',
            data: {
                year1: year1,
                year2: year2
